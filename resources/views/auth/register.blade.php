...
<html lang="en">
    ...
    <body class="auth-body-bg" style="margin-top: -70px;">
                        ...
                        <div class="text-center mt-4">
                            <div class="mb-3">
                                <a href="index.html" class="auth-logo">
                                    <img src="{{ asset('backend/assets/images/logo-dark.png') }}" height="120" class="logo-dark mx-auto" alt="">
                                    <img src="{{ asset('backend/assets/images/logo-light.png') }}" height="120" class="logo-light mx-auto" alt="">
                                </a>
                            </div>
                        </div>
